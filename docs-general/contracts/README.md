...
- `runs/<runId>/charts/<timeframe>/<chartTemplateId>/manifest.json`
- `runs/<runId>/charts/<timeframe>/<chartTemplateId>/<generatedAt>__<symbolSlug>__<timeframe>__<chartTemplateId>__<kind>.png`
